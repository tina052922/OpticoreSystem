...
export const COLLEGE_ADMIN_NAV: AdminNavItem[] = [
  ...
  { label: "Colleges, Programs & Sections", href: "/admin/college/academic-structure", icon: "Network" },
...
export const DOI_ADMIN_NAV: AdminNavItem[] = [
  ...
  { label: "Colleges, Programs & Sections", href: "/doi/academic-structure", icon: "Network" },
