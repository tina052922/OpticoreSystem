 ...
 *  Note: prefer `SLOT_BOUNDS` which handles PM labels (1:00-2:00 → 13:00-14:00).
 *  This exported function is used only for one-off lookups with 24h labels. */
...
const SLOT_BOUNDS = (() => {
  ...
  for (const label of INS_TIME_SLOTS) {
