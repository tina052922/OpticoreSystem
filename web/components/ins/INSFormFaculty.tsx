        ...
        <div className="mb-4 max-w-[1200px] mx-auto space-y-2">
          ...
          {insBasePath.includes("/gec") ? (
            <p className="text-xs text-amber-950 bg-amber-50 border border-amber-200 rounded-md px-3 py-2 max-w-3xl">
              <strong>Vacant GEC slots</strong> (GEC-/GEE- subjects with the placeholder instructor) show an{" "}
              <span className="text-[#c26100] font-semibold">orange outline</span> in the weekly grid.
            </p>
          ) : null}
        </div>
      ) : null}
